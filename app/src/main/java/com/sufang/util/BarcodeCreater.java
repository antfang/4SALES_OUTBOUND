...
//            // 缩放原图
////            matrix.postScale(((float) 390) /ruseltBitmap.getWidth(), 1f);
//            // 向左旋转45度，参数为正则向右旋转
//            matrix.postRotate(_s_45);
//            Bitmap newbitm = Bitmap.createBitmap(ruseltBitmap, 0, 0, ruseltBitmap.getWidth(), ruseltBitmap.getHeight(),
//                    matrix, true);
//            return newbitm;
//        }
        return ruseltBitmap;
...
//        int smallH=5;
//        // 重新定义大小
//        int newW = width+smallW*2;
//        int newH = height+smallH*2;
//
//        // 绘原图
...
//
//        // 绘边框
//        canvas.drawBitmap(bitmap, (newW - width - 2 * smallW) / 2 + smallW, (newH
//                - height - 2 * smallH)
//                / 2 + smallH, null);
//
//        canvas.save();
